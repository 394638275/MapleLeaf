package com.lew.mapleleaf.ui.views;
...
public class ColumnHorizontalScrollView extends HorizontalScrollView {
	...
	protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
		...
		shade_ShowOrHide();
		if (!activity.isFinishing() && ll_content != null && leftImage != null && rightImage != null && ll_more != null
				&& rl_column != null) {
	 ...
	 * 传入父类布局中的资源文件
	 * */
	public void setParam(Activity activity, int mScreenWitdh, View paramView1, ImageView paramView2,
