package com.lew.mapleleaf.utils.logger;
...
/**
 * Logger is a wrapper of {@link android.util.Log} But more pretty, simple and powerful
 *
 * @author Orhan Obut
 */
public final class Logger {
	...
	/**
	 * TAG is used for the Log, the name is a little different in order to differentiate the logs easily with the filter
	 */
